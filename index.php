...
<?php include 'header.php'; ?>
        <div class="layer">
                                <div class="valknut">
                                        <img src="img/valknut.jpg">
                                </div>
                                <div class="my_player_content">
                                    <div class="player">
                                                <div class="main">
                                                        <audio></audio>
                                                        <div class="thumbnail">
        ...
        <section class="biography">
                <div class="biography-divider">
                        <div class="bio-two-invisible">
                                <div class="triangle">
                                        <h3 class="triangle-text">Biography</h3>
                                </div>
                                <div class="lds-ellipsis"><div></div><div></div><div></div><div></div></div>
                        </div>
                        <div class="bio-one">
                                <h1>First Band</h1>
                                <div class="bio-one-content">
                        ...
                        <div class="bio-two">
                                ...
                                <div class="lds-ellipsis"><div></div><div></div><div></div><div></div></div>
                                <img class="thor-img" src="img/thor.png">
                        </div>
                        <div class="bio-three">
                                <h1>Nordicmann project</h1>
                                <div class="bio-three-content">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
                                        </p>
                                </div>
       ...
       <div class="home-more-stuff">
         <div class="more-stuff-grid">
           ...
           <div class="slide-in from-right">
                 <h1 class="slide-heading">Albums</h1>
                 <p class="texter">
         ...
         <div class="more-stuff-grid">
           <div class="slide-in from-left">
                 <h1 class="slide-heading">Blog</h1>
                 <p class="texter">
             Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis fugit,
             quae beatae vero sit magni quaerat id ratione. Dolor optio unde amet
             omnis sapiente neque cumque consequuntur reiciendis deserunt.
         ...
         <div class="more-stuff-grid">
           ...
           />
           <div class="slide-in from-right">
                 <h1 class="slide-heading">Stories</h1>
                 <p class="texter">
             Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis fugit,
             quae beatae vero sit magni quaerat id ratione. Dolor optio unde amet
             omnis sapiente neque cumque consequuntur reiciendis deserunt.
     ...
     <section class="container-test">
             ...
             <div class='intro_cont'>
                ...
                <div class="map-wrapper">
                                 <div id="cont" style="position: relative; width: 500px; height: 300px;"></div>
                                 <div class="location">
                                         <h3>Location: City - Minsk, Country - Belarus</h3>
                                 </div>
                </div>
                <div class="contact-wrapper">
                         ...
                         <form action="/action_page.php">
                                           ...
                                           <div class="row">
                                             <input class="submit-var" type="submit" value="Submit">
                                           </div>
                                     </form>
                </div>
        ...
        <section class="quiz">
                <div class="quiz-wrapper">
                        <div class="quiz-layer"> </div>
                        <div class="quiz-content">
                                <h2>Get a free track after QUIZ</h2>
                                <ul>
                                        <li><p>'Question 1:' ?</p></li>
                                        <li>
                                                <input type="radio" id="male" name="gender" value="Yes">Yes
                                                <input type="radio" id="male" name="gender" value="No">No
                                        </li>
                                </ul>
